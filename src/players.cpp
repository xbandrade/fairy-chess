...
void createDefaultPieces(int player, std::vector<Piece *> &positions){
    if (player == 1){
        ...
        positions[8] = new Camel(8, 1);
        positions[9] = new Wazir(9, 1);
        for (int i = 2; i < 6; i++){
            positions[8 + i] = new Pawn(8 + i, 1);
        }
        positions[14] = new Wazir(14, 1);
        positions[15] = new Grasshopper(15, 1);
        ...
        positions[55] = new Grasshopper(55, 2);
        positions[54] = new Wazir(54, 2);
        for (int i = 2; i < 6; i++){
            positions[48 + i] = new Pawn(48 + i, 2);
        }
        positions[49] = new Wazir(49, 2);
        positions[48] = new Camel(48, 2);
